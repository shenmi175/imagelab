...
export const env = {
  ...
  upstreamInputImageMaxBytes: numberEnv("UPSTREAM_INPUT_IMAGE_MAX_BYTES", 1_200_000),
  upstreamInputImagesTotalMaxBytes: numberEnv("UPSTREAM_INPUT_IMAGES_TOTAL_MAX_BYTES", 4_000_000),
  upstreamInputImageMaxEdge: numberEnv("UPSTREAM_INPUT_IMAGE_MAX_EDGE", 1536),
  upstreamInputImageQuality: numberEnv("UPSTREAM_INPUT_IMAGE_QUALITY", 84),
