...
export const env = {
  ...
  runningJobStaleSeconds: numberEnv("RUNNING_JOB_STALE_SECONDS", 960),
  outboxDispatchIntervalSeconds: numberEnv("OUTBOX_DISPATCH_INTERVAL_SECONDS", 10),
  reconcileIntervalSeconds: numberEnv("RECONCILE_INTERVAL_SECONDS", 60),
...
export const allowedSizes = new Set(["1024x1024", "1536x1024", "1024x1536"]);
export const allowedQualities = new Set(["low", "medium", "high"]);
